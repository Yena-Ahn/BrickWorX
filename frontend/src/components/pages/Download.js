...
const Download = () => {
  return (
    <div>
      ...
      <a href="http://52.64.233.59:3001/s3DOWNLOAD?fn=CanvasExportExample.csv" className="btn btn-primary btn-lg downloadBtn" style={{ align:"center"}}> <Icon.Download/> Download Gradebook</a>
