...
const Download = () => {
  return (
    <div>
      ...
      <a href="http://localhost:3001/s3DOWNLOAD?fn=feedback.csv" className="btn btn-primary btn-lg downloadBtn" style={{ align:"center"}}> <Icon.Download/> Download Gradebook</a>
